...
<?php
    ...
    if (isset($_REQUEST['username'])) {
        ...
        if ($result) {
            echo "<div class='form'>
                  <h3>Te has registrado exitosamente!.</h3><br/>
                  <p class='link'>Click here to <a href='login.php'>Login</a></p>
                  </div>";
        } else {
            echo "<div class='form'>
                  <h3>Algunos campos estan vacios o no correponden al formato.</h3><br/>
...
?>
    <form class="form" action="" method="post">
        ...
        <p class="link"><a href="login.php">Iniciar Sesion</a></p>
    </form>
<?php
    }
?>
